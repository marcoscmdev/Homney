...
public class UtilidadesNavigationDrawer {
    ...
    public static void cambiarCabecera(NavigationView navigationView, int idRecursoImagen, String textoCabecera1, String textCabecera2) {
        TextView tv_cabecera1 = ((navigationView.getHeaderView(0).findViewById(R.id.tv_cabecera1)));
        tv_cabecera1.setText(textoCabecera1);

        TextView tv_cabecera2 = ((navigationView.getHeaderView(0).findViewById(R.id.tv_cabecera2)));
        tv_cabecera2.setText(textCabecera2);

        ImageView imageViewCabecera = ((navigationView.getHeaderView(0).findViewById(R.id.imageViewCabecera)));
